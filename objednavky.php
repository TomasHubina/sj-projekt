...
if(isset($_GET['detail']) && !empty($_GET['detail'])) {
    ...
    $detail_sql = "SELECT o.*, p.email FROM objednavky o 
                                ...
                                <div class="card admin-card text-white">
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap gap-2 mb-3">
                                            <a href="objednavky.php" class="btn btn-sm <?php echo empty($filter_stav) ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                                Všetky (<?php echo $celkovy_pocet; ?>)
                                            </a>
                                            <a href="objednavky.php?stav=Nová" class="btn btn-sm <?php echo $filter_stav == 'Nová' ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                                Nové (<?php echo isset($stavy_pocty['Nová']) ? $stavy_pocty['Nová'] : 0; ?>)
                                            </a>
                                            <a href="objednavky.php?stav=Spracovaná" class="btn btn-sm <?php echo $filter_stav == 'Spracovaná' ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                                Spracované (<?php echo isset($stavy_pocty['Spracovaná']) ? $stavy_pocty['Spracovaná'] : 0; ?>)
                                            </a>
                                            <a href="objednavky.php?stav=Odoslaná" class="btn btn-sm <?php echo $filter_stav == 'Odoslaná' ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                                Odoslané (<?php echo isset($stavy_pocty['Odoslaná']) ? $stavy_pocty['Odoslaná'] : 0; ?>)
                                            </a>
                                            <a href="objednavky.php?stav=Doručená" class="btn btn-sm <?php echo $filter_stav == 'Doručená' ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                                Doručené (<?php echo isset($stavy_pocty['Doručená']) ? $stavy_pocty['Doručená'] : 0; ?>)
                                            </a>
                                            <a href="objednavky.php?stav=Zrušená" class="btn btn-sm <?php echo $filter_stav == 'Zrušená' ? 'btn-primary' : 'custom-btn custom-border-btn'; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card order-detail-card">
                                                    ...
                                                    <div class="card-body">
                                                        <p><strong>Meno:</strong> <?php echo $detail_objednavky['meno'] . " " . $detail_objednavky['priezvisko']; ?></p>
                                                    ...
                                                    <?php if(mysqli_num_rows($result) > 0): ?>
                                                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="objednavky.php?detail=<?php echo $row['objednavka_id']; ?>" class="btn btn-primary btn-sm">
